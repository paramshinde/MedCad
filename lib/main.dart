...
Future<void> main() async {
  ...
  try {
    ...
    // If Firebase init fails, log but continue (optional: show an error UI)
    // In most cases this shouldn't happen if firebase_options.dart is configured.
    debugPrint('Firebase initialization error: $e\n$st');
  }

  // Initialize local/notification services (after Firebase if they need it)
  try {
